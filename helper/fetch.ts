...
export function fetchWalletBlance() {
  return new Promise<IWalletBalance[]>((resolve, reject) => {
    return resolve([
      {
        currency: "USDT",
        amount: 1245,
...
export function fetchCoinList() {
  return new Promise<coinItem[]>((resolve, reject) => {
    return resolve([
      {
        coin_id: "BTC",
        name: "Bitcoin",
...
export type overviewItem = IRate & coinItem & IWalletBalance & { value: string };
